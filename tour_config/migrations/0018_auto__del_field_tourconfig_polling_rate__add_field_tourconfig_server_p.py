...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TourConfig.server_polling_rate'
        db.add_column(u'tour_config_tourconfig', 'server_polling_rate',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=600),
                      keep_default=False)

        # Adding field 'TourConfig.location_polling_rate'
        db.add_column(u'tour_config_tourconfig', 'location_polling_rate',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'tour_config_tourconfig', 'polling_rate',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=600000),
                      keep_default=False)

        # Deleting field 'TourConfig.server_polling_rate'
        db.delete_column(u'tour_config_tourconfig', 'server_polling_rate')

        # Deleting field 'TourConfig.location_polling_rate'
        db.delete_column(u'tour_config_tourconfig', 'location_polling_rate')
