...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TourConfig.server_polling_range'
        db.add_column(u'tour_config_tourconfig', 'server_polling_range',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'TourConfig.server_polling_range'
        db.delete_column(u'tour_config_tourconfig', 'server_polling_range')
    ...
    models = {
        u'tour_config.tourconfig': {
            ...
            'server_polling_range': ('django.db.models.fields.PositiveIntegerField', [], {'default': '5'}),
