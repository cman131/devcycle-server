...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TourConfig.poll_rate'
        db.delete_column(u'tour_config_tourconfig', 'poll_rate')
    ...
    def backwards(self, orm):
        # Adding field 'TourConfig.poll_rate'
        db.add_column(u'tour_config_tourconfig', 'poll_rate',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=600000),
                      keep_default=False)
    ...
    models = {
        u'tour_config.tourconfig': {
            ...
            'polling_rate': ('django.db.models.fields.PositiveIntegerField', [], {'default': '600000'}),
