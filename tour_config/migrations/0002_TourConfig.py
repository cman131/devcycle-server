...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'TourConfig', fields ['tour_id']
        db.create_index('tour_config_tourconfig', ['tour_id'])


    def backwards(self, orm):
        # Removing index on 'TourConfig', fields ['tour_id']
        db.delete_index('tour_config_tourconfig', ['tour_id'])


        # Changing field 'TourConfig.tour_id'
        db.alter_column('tour_config_tourconfig', 'tour_id', self.gf('django.db.models.fields.CharField')(max_length=256))
    ...
    models = {
        'tour_config.tourconfig': {
            ...
            'tour_id': ('django.db.models.fields.SlugField', [], {'max_length': '256'}),
